                ...
                <div className="max-w-3xl mx-auto space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        <WaitlistModal>
                            <Button
                                size="lg"
                                className="rounded-full bg-slate-900 text-white hover:bg-slate-800 transition-all font-semibold h-14 px-8 text-base shadow-xl hover:shadow-2xl hover:-translate-y-0.5"
                            >
                                Join the waitlist
                    ...
                    <div className="flex items-center justify-center gap-6 pt-8 text-sm text-slate-500">
                        <span className="flex items-center gap-1.5"><Check className="w-4 h-4 text-emerald-500" /> Free during beta</span>
