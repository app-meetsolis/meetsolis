      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <p className="text-lg md:text-xl text-slate-500 max-w-xl mx-auto leading-relaxed">
            To know what happened in the last meeting, you&apos;re forced to dig
            through emails, DMs, and drive folders. Stop playing detective with
            your own business.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-[1280px] mx-auto">
          ...
          <div className="group bg-white rounded-[32px] p-8 border border-slate-200 flex flex-col h-[520px] relative overflow-hidden transition-all hover:shadow-xl hover:-translate-y-1">
            ...
            <p className="text-slate-500 leading-relaxed max-w-xs">
              Your client history is split across too many apps. You have to
              check three different places just to find the context you need.
            </p>
          ...
          <div className="group bg-white rounded-[32px] p-8 border border-slate-200 flex flex-col h-[520px] relative overflow-hidden transition-all hover:shadow-xl hover:-translate-y-1">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-3">
              The &quot;Did I Promise That?&quot; Anxiety
            </h3>
            <p className="text-slate-500 leading-relaxed max-w-xs">
              Action items get buried in the scroll. Without a central memory,
              you&apos;re constantly second-guessing what you promised in that
              last call.
            </p>
          ...
          <div className="group bg-white rounded-[32px] p-8 border border-slate-200 flex flex-col h-[520px] relative overflow-hidden transition-all hover:shadow-xl hover:-translate-y-1">
            ...
            <p className="text-slate-500 leading-relaxed max-w-xs">
              You start meetings flustered, frantically tab-switching to find
              that one file or note from last week.
            </p>
              ...
              <div className="w-full max-w-[280px] bg-white/90 backdrop-blur-md rounded-xl shadow-xl border border-slate-200/60 p-4 z-20 flex flex-col gap-4">
                ...
                <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
                  ...
                  <div className="flex-1 overflow-hidden h-5 relative">
                    ...
                    >
                      <span className="text-sm text-slate-400 h-5 block">
                        proposal_v3.pdf
                      </span>
                      <span className="text-sm text-slate-400 h-5 block">
                        client_brief_final.docx
                      </span>
                      <span className="text-sm text-slate-400 h-5 block">
                        roadmap_2024.ppt
                      </span>
...
function OrbitItem({
  ...
  color,
  bg,
  parentRotationDuration,
  parentCounterRotateValue,
  ringSize,
}: {
  angle: number;
  icon: any;
    ...
    >
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
        <motion.div
          ...
          transition={{
            duration: parentRotationDuration,
            repeat: Infinity,
            ease: 'linear',
          }}
        >
