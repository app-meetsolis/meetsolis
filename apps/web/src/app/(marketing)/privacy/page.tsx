        ...
        <div className="container px-4 md:px-6 pt-32 md:pt-40 pb-12 max-w-5xl mx-auto">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-slate-500 max-w-2xl leading-relaxed">
              Transparency is key. We want you to understand exactly how we
              collect, store, and use your data to help you organize your
              memory.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-64 shrink-0">
            <div className="sticky top-24 space-y-8">
              <div className="p-6 bg-white rounded-2xl border border-slate-200 shadow-sm">
                ...
                <div className="text-slate-500 options">
          ...
          <div className="flex-1 bg-white p-8 md:p-12 rounded-[32px] border border-slate-200 shadow-sm">
            <div className="prose prose-slate prose-lg max-w-none prose-headings:font-bold prose-headings:text-slate-900 prose-headings:scroll-mt-24 prose-p:text-slate-600 prose-p:leading-relaxed prose-li:text-slate-600 prose-a:text-blue-600 hover:prose-a:text-blue-700">
              <p>
                At MeetSolis, we take your privacy seriously. This Privacy
                Policy describes how we collect, use, and share information when
                you use our AI meeting assistant service.
              </p>
              ...
              <p>
                <strong>Account Information:</strong> We collect your name,
                email address, and authentication information when you sign up.
              </p>
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4 my-4 not-prose rounded-r-lg">
                <p className="text-sm text-blue-900 m-0">
                  <strong>Why?</strong> This is needed to secure your personal
                  dashboard and ensure only you have access to your meetings.
                </p>
              </div>
              <p>
                <strong>Meeting Data:</strong> To provide our core service, we
                process audio recordings, transcripts, and calendar details
                (&quot;Meeting Data&quot;) that you authorize us to access.
              </p>
              <p>
                <strong>Usage Data:</strong> We collect anonymous data about how
                you interact with our website and application to improve
              ...
              <ul className="marker:text-slate-400">
                <li>
                  <strong>Service Delivery:</strong> To transcribe meetings,
                  generate summaries, and extract action items as requested by
                  you.
                </li>
                <li>
                ...
                <li>
                  ...
                  improve our AI models (only with anonymized data or explicit
                  consent).
                </li>
              </ul>
              ...
              <p>
                You retain full control over your Meeting Data. You can delete
                your recordings and transcripts at any time through your account
                dashboard, and we will permanently remove them from our systems.
              </p>
              ...
              <p>
                ...
                with third-party service providers (e.g., cloud hosting, AI
                processing APIs) strictly necessary to operate our Service, and
              ...
              <p>
                Our Service utilizes Artificial Intelligence technologies to
                process Meeting Data. While we strive for accuracy, AI-generated
                content may occasionally contain errors. We recommend verifying
