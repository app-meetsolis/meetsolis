        ...
        <div className="container px-4 md:px-6 pt-32 md:pt-40 pb-12 max-w-5xl mx-auto">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-slate-500 max-w-2xl leading-relaxed">
              ...
              outline your rights and obligations when using MeetSolis.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 bg-white p-8 md:p-12 rounded-[32px] border border-slate-200 shadow-sm">
            <div className="prose prose-slate prose-lg max-w-none prose-headings:font-bold prose-headings:text-slate-900 prose-headings:scroll-mt-24 prose-p:text-slate-600 prose-p:leading-relaxed prose-li:text-slate-600 prose-a:text-blue-600 hover:prose-a:text-blue-700">
              ...
              <p>
                By accessing and using MeetSolis (&quot;the Service&quot;), you
              ...
              <p>
                MeetSolis is an AI-powered meeting assistant that provides
                transcription, summarization, and organizational tools for
                freelancers and professionals. The Service integrates with
                third-party platforms such as Google Calendar and Zoom to
                function.
              </p>
              ...
              <p>
                ...
                and password. MeetSolis cannot and will not be liable for any
                loss or damage from your failure to comply with this security
                obligation. You are responsible for all Content posted and
              ...
              <p>
                ...
                information and data is governed by our Privacy Policy. By using
                MeetSolis, you consent to the collection and use of information
              ...
              <p>
                ...
                data, text, audio, and other content you upload or generate via
                the Service (&quot;User Content&quot;). We claim no intellectual
              ...
              <div className="bg-slate-50 border-l-4 border-slate-900 p-4 my-4 not-prose rounded-r-lg">
                <p className="text-sm text-slate-700 m-0">
                  <strong>Note:</strong> While we don&apos;t own your content,
                  we need a license to process it (e.g., to generate your
                  summaries). This permission is limited strictly to providing
                  the service.
                </p>
              </div>
              <p>
                <strong>Our IP:</strong> The MeetSolis platform, including its
                software, design, and branding, is the exclusive property of
                MeetSolis and its licensors.
              </p>
